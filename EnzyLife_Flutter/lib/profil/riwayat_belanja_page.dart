...
class _RiwayatBelanjaScreenState extends State<RiwayatBelanjaScreen> {
  ...
  List<OrderModel> get _filtered {
    final list = _allOrders.where((o) {
      ...
      return o.items.any(
        (item) => (item.product?.name ?? '').toLowerCase().contains(queryLower),
      );
    }).toList();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const SubPageAppBar(title: 'Riwayat Belanja'),
      body: Stack(
            ...
            children: [
              ...
              const Padding(
                ...
                child: PageHeaderCard(
                  ...
                  subtitle:
                      'Pantau status pesanan, riwayat belanja produk eco enzyme, serta lakukan pembayaran dan ulasan dalam satu tempat.',
                  ...
                  child: Row(
                    children: [
                      ...
                      ...OrderStatus.values.map(
                        (status) => _buildFilterTab(status, status.label),
                      ),
                    ],
                  ),
                ),
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl =
        (firstItem?.product?.image != null &&
            firstItem!.product!.image.isNotEmpty)
        ? 'https://undergo-refill-bonehead.ngrok-free.dev/gambar/produk/${firstItem.product!.image.split('/').last}'
        : null;
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                'Total: ${fmtPrice(order.totalHarga)}',
  ...
  Future<void> _cancelOrder(BuildContext context, OrderModel order) async {
    ...
    if (res != null && res['success'] == true) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            res?['message'] ?? 'Gagal membatalkan pesanan. Silakan coba lagi.',
          ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) =>
                              DetailRiwayatBelanjaPage(order: order),
                        ),
                      );
                    },
                    style: ElevatedButton.styleFrom(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (ctx, idx) {
                    ...
                    final imageUrl = prod.image.isNotEmpty
                        ? 'https://undergo-refill-bonehead.ngrok-free.dev/gambar/produk/${prod.image.split('/').last}'
                        : null;
