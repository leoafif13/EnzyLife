          ...
          SafeArea(
            child: Column(
              children: [
                ...
                // Form card — scrollable karena field lebih banyak
                Expanded(
                  child: FadeTransition(
                    opacity: _fadeIn,
                    child: SlideTransition(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed:
                                      (_isLoading || !_agreeTerms) ? null : _handleRegister,
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: _green500,
                                    foregroundColor: Colors.white,
                                    disabledBackgroundColor:
                                        _green500.withOpacity(0.45),
                                    elevation: 0,
                                    shape: RoundedRectangleBorder(
...
// ══════════════════════════════════════════════
//  Top section: logo kecil + tagline
// ══════════════════════════════════════════════
...
// ══════════════════════════════════════════════
//  Background orbs (variasi posisi beda dari login)
// ══════════════════════════════════════════════
...
class _RegisterOrbPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Orb kanan atas besar
    canvas.drawCircle(
      Offset(size.width * 0.92, size.height * 0.08 + dy1),
      size.width * 0.32,
      Paint()..color = const Color(0xFF2E7D32).withOpacity(0.5),
    );

    // Orb kiri tengah atas
    canvas.drawCircle(
      Offset(size.width * 0.0, size.height * 0.18 + dy2),
      size.width * 0.18,
      Paint()..color = const Color(0xFF388E3C).withOpacity(0.4),
    );

    // Orb kecil kanan tengah
    canvas.drawCircle(
      Offset(size.width * 0.95, size.height * 0.28 - dy1 * 0.6),
      size.width * 0.08,
...
// ══════════════════════════════════════════════
//  Reusable input field (sama dengan login)
// ══════════════════════════════════════════════
